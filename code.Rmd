...
ggsave("histograms.png", width = 8, height = 10, dpi = 600, bg = "white")
```
...
ggsave("BOX_plots.png", width = 12, height = 10, dpi = 600, bg = "white")
```
...
ggsave("sev_yld.png", width = 8, height = 5, dpi = 600, bg = "white")
```
...
ggsave("DON_yld.png", width = 8, height = 5, dpi = 600, bg = "white")
```
...
ggsave("COMBO.png", height=7, width=13, dpi = 600, bg = "white")
```
